...
method new() class TinfModal
	::documentation := "infModal | Informações do modal"+CRLF+"XML do modal: XML específico do modal (rodoviário, aéreo, ferroviário, aquaviário ou dutoviário)."
	::value := "TinfModal"
	::rodo := Trodo():new()
	::aereo := Taereo():new()
return self
