...
method new() class TinfCteAnu
	::documentation := "infCteAnu | Detalhamento do CT-e do tipo Anulação"
	::value := "TinfCteAnu"
	::chCte := Telement():new({'name' => "chCte", 'documentation' => "Chave de acesso do CT-e original a se anulado e substituído", 'minLength' => 44, 'type' => "N"})
	::dEmi := Telement():new({'name' => "dEmi", 'documentation' => "Data de emissão da declaração do tomador não contribuinte do ICMS", 'minLength' => 10, 'type' => "D"})
return self