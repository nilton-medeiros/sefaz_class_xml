...
method new() class Taereo
	...
	::natCarga := TnatCarga():new()
	::tarifa := Ttarifa():new()
	::peri := Telement():new({'name' => "peri", 'documentation' => "Preenchido quando for transporte de produtos classificados pela ONU como perigosos.",;
									  'value' => {}, 'minLength' => 0, 'maxLength' => 99999, 'type' => "A"})
return self

method addperi(peri) class Taereo
	AAdd(::peri:value, Tperi():new(peri))
return ::peri:value[hmg_len(::peri:value)]
