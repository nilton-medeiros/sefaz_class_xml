...
class TvPrest
	...
	method addComp(pComp)
end class

method new() class TvPrest
	::documentation := "vPrest | Valores da Prestação de Serviço"
	::value := "TvPrest"
	::vTPrest := Telement():new({'name' => "vTPrest", 'documentation' => "Valor Total da Prestação do Serviço", 'type' => "N", 'minLength' => 4, 'maxLength' => 16})
	::vRec := Telement():new({'name' => "vRec", 'documentation' => "Valor a Receber", 'type' => "N", 'minLength' => 4, 'maxLength' => 16})
	::Comp := {}
return self

method addComp(pComp) class TvPrest
	AAdd(::Comp, TComp():new(pComp))
return nil
