...
class Tcobr
	data documentation init "cobr | Dados da cobrança do CT-e" READONLY
	data value init "Tcobr" READONLY
	data fat
	data dup
...
method new() class Tcobr
	::fat := Tfat():new()
	::dup := Telement():new({'name' => "dup", 'documentation' => "Dados das duplicatas", 'value' => {}, 'minLength' => 0, 'maxLength' => 99999, 'type' => "A"})
return self
method addDup(dup)
	AAdd(::dup:value, Tdup():new(dup))
return ::dup:value[hmg_len(::dup:value)]
