...
method new() class TinfCteComp
	::documentation := "infCteComp | Detalhamento do CT-e complementado"
	::value := "TinfCteComp"
	::chCTe := Telement():new({'name' => "chCTe", 'documentation' => "Chave do CT-e complementado", 'minLength' => 44, 'type' => "N"})
return self
