...
method new() class TICMS90
	::documentation := "ICMS90 | ICMS Outros"
	::submit := False
	::value := "TICMS90"
	::CST := Telement():new({'name' => "CST", 'documentation' => "Classificação Tributária do Serviço"+CRLF+"90 - ICMS outros",;
