...
method new() class TinfCTeSupl
   ::documentation := "Informações suplementares do CT-e"
   ::name := "infCTeSupl"
   ::value := "TinfCTeSupl"
   ::qrCodCTe := Telement():new({'name' => "qrCodCTe", 'documentation' => 'Texto com o QR-Code impresso no DACTE', 'minLength' => 50, 'maxLength' => 1000})
return self