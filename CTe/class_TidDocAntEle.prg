...
method new() class TidDocAntEle
	::documentation := "idDocAntEle | Documentos de transporte anterior eletrônicos"
	::submit := False
	::value := "TidDocAntEle"
	::chCTe := Telement():new({'name' => "chCTe", 'documentation' => "Chave de acesso do CT-e", 'minLength' => 44, 'type' => "N"})
return self
